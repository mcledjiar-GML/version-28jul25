        ...
        {selectedStudent && (
          <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                ...
                <button
                  onClick={() => {
                    if (selectedStudent && selectedWeek) {
                      console.log(`Lancement du calcul pour ${selectedStudent.prenom} ${selectedStudent.nom} - Semaine: ${selectedWeek}`);
                      // Ici vous pourrez ajouter la logique pour sauvegarder ou traiter les calculs
                    }
                  }}
            ...
            <p className="text-sm text-gray-500 mt-2">
              Sélectionnez la semaine pour laquelle vous souhaitez effectuer les calculs nutritionnels.
              {selectedWeek && (
